...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'attachment_attachment', (
            ...
            ('lesson', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lesson.Lesson'], null=True, blank=True)),
        ...
        # Adding unique constraint on 'Attachment', fields ['lesson', 'seq']
        db.create_unique(u'attachment_attachment', ['lesson_id', 'seq'])

        # Adding unique constraint on 'Attachment', fields ['course', 'seq']
        db.create_unique(u'attachment_attachment', ['course_id', 'seq'])


    def backwards(self, orm):
        # Removing unique constraint on 'Attachment', fields ['course', 'seq']
        db.delete_unique(u'attachment_attachment', ['course_id', 'seq'])

        # Removing unique constraint on 'Attachment', fields ['lesson', 'seq']
        db.delete_unique(u'attachment_attachment', ['lesson_id', 'seq'])
