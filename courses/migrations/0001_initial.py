...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'courses_course', (
            ...
            ('organiser', self.gf('django.db.models.fields.related.ForeignKey')(related_name='courses_organised_set', to=orm['auth.User'])),
            ('instructor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='courses_instructed_set', to=orm['auth.User'])),
        ))
