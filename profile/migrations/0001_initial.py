...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profile_profile', (
            ...
            ('user_tz', self.gf('django.db.models.fields.CharField')(default=u'UTC', max_length=255)),
            ('accepted_terms', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('signature_line', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=10000, blank=True)),
            ('webpage', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
    ...
    models = {
        ...
        u'profile.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'signature_line': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
            'user_tz': ('django.db.models.fields.CharField', [], {'default': "u'UTC'", 'max_length': '255'}),
